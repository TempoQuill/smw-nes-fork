...
@Continue:
	...
	;This seems redundant as the green Koopa has it's own code
		...
		BNE @Stop ;Only continue every even frame
			LDA #$10
			JMP GetMovementData ;Get movement data for Koopa
	@Stop:
		RTS
...
GetRedKoopaMovementData:
	...
	BNE @Stop ;Only continue every even frame
		LDA #$10
		JMP sub_54_B3B4 ;Load movement data for Koopa
@Stop:
	RTS
...
bra8_8596:
	...
	;If Rex was already squished:
		...
		JMP Obj_StompReboundNoSFX ;Make player bounce off the Rex without playing a sound
		RTS
...
bra8_8648:
	...
	JMP Obj_StompRebound ;Make player bounce off the Rex
	RTS
...
bra8_8979:
	...
	; If motion is starting
		...
		JMP jmp_54_B5BB ;Turn object to face the player
		RTS
